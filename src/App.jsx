...
export default function App() {
  ...
  const onCadastrado = (p) => {
    ...
    setPaciente(p);
    setTela("paciente");
    // Mostra tutorial só na primeira vez
      ...
      <nav style={{ background: "#1E5C3A", padding: "0 16px", height: 52, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 998, boxShadow: "0 2px 12px rgba(0,0,0,0.25)", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <button
            ...
            title="Ver tutorial"
            style={{ background: "rgba(255,255,255,0.1)", border: "none", borderRadius: 8, padding: "5px 8px", cursor: "pointer", fontSize: 14, color: "rgba(255,255,255,0.7)" }}
          >
            ❓
          </button>
          <button onClick={() => setTela("admin")} title="Admin" style={{ background: "rgba(255,255,255,0.1)", border: "none", borderRadius: 8, padding: "5px 8px", cursor: "pointer", fontSize: 14, color: "rgba(255,255,255,0.5)" }}>⚙️</button>
